...
import { PackageCheck, Rocket, ShieldCheck, UserCheckIcon } from "lucide-react" // Added PackageCheck, Rocket, and ShieldCheck icon imports
    ...
    <section ref={containerRef} className="relative h-screen overflow-hidden">
      ...
      >
        <Image
          ...
          alt="Gideon B. Shops - Elegant interior with sage green walls and terracotta furniture overlooking surreal landscape"
          fill
        ...
        <BlurPanel className="mx-6 mb-6 px-6 py-4 bg-black/24 backdrop-blur-md border-white/20">
          <div className="flex items-center justify-center gap-6 text-white/90">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">Globally trusted  </span>
            </div>
            <div className="flex items-center gap-2">
